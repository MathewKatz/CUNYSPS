...
counts
```
**4792 within zero// 925 within one to two//373 within ten to nineteen// 298 within twenty to twenty nine// 493 within three to five// 827 within thirty// 311 within six to nine// 4646 did not drive// 918 NAs**
...
```
**6040 reported text while driving every day in the past 30 days and never wear helmet to 463 who wore helmet and texted while driving in the past 30 days.**
...
moe
```
**The margin of error is about .59%**
...
moe
```
**There is 95% confidence that the proportion of students who exercise more than once a week is between 15.79% and 17.02% and MOE is 0.16%**
...
moe
```
**There is 95% confident that the proportion of students who sleeps more than 5 hours is between 7.38% and 8.31% and MOE is 0.062%**
...
**The sampling distribution of sample proportions at n = 300 and p = 0.1. is normal, unimodal, centered at 0.1, spread between 0.01 and 0.14.**
...
**With n constant, as p increases up to reach 50%, there is more spread around the center and the shape is still normal and when p start increasing from 50%, the spread start decreasing.**
    
8.  Now also change $n$. How does $n$ appear to affect the distribution of $\hat{p}$?
**As n increases, the distribution become more and more normal. There is less spread and there is more data toward the center. In term of confidence interval, the standard error decreases (less spread), therefore the margin of error decreases as well.**
...
**The probability of making type I error is the level of significance. At α=0.05, I am willing to accept 5% chance that I am wrong when I reject the null hypothesis. The probability that I could detect a change at α=0.05 is 5%**
